...
pub const default_bindings: []const Binding = &.{
    ...
    .{ .chords = &.{ c(']'), c('t') }, .command = .next_turn, .desc = "next turn or commit, ending at the whole change", .hint = null, .group = .turns },
    .{ .chords = &.{ c('['), c('t') }, .command = .prev_turn, .desc = "previous turn or commit - what was written by then", .hint = null, .group = .turns },
    ...
    .{ .chords = &.{ leader, c('l'), c('t') }, .command = .turn_list, .desc = "list the turns, or the commits of a pull request", .group = .turns },
